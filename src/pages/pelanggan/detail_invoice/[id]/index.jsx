                ...
                <div className="grid grid-cols-2 mb-6">
                  ...
                  <div className="mx-auto">
                    ...
                    <div className="text-gray-600 max-sm:text-sm grid grid-cols-2">
                      <div>Referensi</div>
                      <div className="-ml-4">: {invoiceData?.refrensi}</div>
                    </div>
                    <div className="text-gray-600 max-sm:text-sm grid grid-cols-2">
                      <div>Tanggal</div>
                      <div className="-ml-4">: {invoiceData?.tanggal}</div>
                    </div>
                    <div className="text-gray-600 max-sm:text-sm grid grid-cols-2">
                      <div>Jatuh Tempo </div>
                      <div className="-ml-4">: {invoiceData?.tgl_jatuh_tempo}</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="mt-6 md:mt-6 lg:mt-0 ">
                  ...
                  <div className="text-gray-600">
                    <div className="grid grid-cols-2 max-sm:text-sm">
                      ...
                      <span className="-ml-65 md:-ml-75">: {settingData?.profil_perusahaan}</span>
                    </div>
                    <div className="grid grid-cols-2 max-sm:text-sm">
                      <span>Alamat Perusahaan</span>
                      <span className="-ml-65 md:-ml-75">: {settingData?.alamat}</span>
                    </div>
                    <div className="grid grid-cols-2 max-sm:text-sm">
                      <span>Telepon Perusahaan</span>
                      <span className="-ml-65 md:-ml-75">: {settingData?.telp}</span>
                    </div>
                    <div className="grid grid-cols-2 max-sm:text-sm">
                      <span>Email Perusahaan</span>
                      <span className="-ml-65 md:-ml-75">: {settingData?.email}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 md:mt-6 lg:mt-0">
                  ...
                  <div className="text-gray-600">
                    <div className="grid grid-cols-2 max-sm:text-sm">
                      ...
                      <span className="-ml-65 md:-ml-75">: {customerData?.nama}</span>
                    </div>
                    <div className="grid grid-cols-2 max-sm:text-sm">
                      <span>Alamat Pelanggan</span>
                      <span className="-ml-65 md:-ml-75">: {customerData?.alamat}</span>
                    </div>
                    <div className="grid grid-cols-2 max-sm:text-sm">
                      <span>Telepon Pelanggan</span>
                      <span className="-ml-65 md:-ml-75">: {customerData?.telp}</span>
                    </div>
                    <div className="grid grid-cols-2 max-sm:text-sm">
                      <span>Email Pelanggan</span>
                      <span className="-ml-65 md:-ml-75">: {customerData?.email}</span>
                    </div>
                  </div>
                </div>
              </div>
